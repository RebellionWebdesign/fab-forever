...
[![compatibility on chrome]({https://github.com/RebellionWebdesign/fab-forever/blob/main/assets/img/fab-forever-hero-section.png})]({(https://github.com/RebellionWebdesign/fab-forever/blob/main/assets/video/chrome.mp4)} "Compatibility on Chrome")
